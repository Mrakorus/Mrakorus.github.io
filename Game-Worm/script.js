window.addEventListener('DOMContentLoaded', function() {
    ...
    let Worm = document.querySelector(".head"),
        ...
        startgame = document.querySelector(".startalone__btn"),
        netwgame = document.querySelector(".netwgame__btn"),
        formtooser = document.querySelector(".formtooser"),
        fonmenu = document.querySelector(".fonmenu"),
        enablnetwgame = false,
        direct = 3,
        tox = 0,
        toy = 0,
...
// console.log(tdatfrser);
    ...
    function checkoppon() {
        ...
        if (chshowopon.checked) {
            ...
            // let delbod = document.querySelectorAll(".body2");
            // for (let i = 0; delbod.length-1 >= i; i++) {
            //     fon.removeChild(delbod[i]);
            // }
    ...
    chshowopon.addEventListener("click", function() {
        enablnetwgame = checkoppon();

    });
    netwgame.addEventListener("click", function() {
        if(formtooser.style.display == "flex" || formtooser.style.display == "block"){
 // formtooser.classList.add("hide");
        formtooser.style.display = "none";
        }else{
        formtooser.style.display = "flex";
        // formtooser.classList.remove("hide");
}
    });
